...
void ADC_GPIO_Configuration(void){
    ...
    GPIO_Init(GPIO_CRH_CNF10_0,&Gpio_InitStructure);
}
/********************************************** ADC模块初始化 **********************************************/
void ADC_Configuration(void){
    ...
    ADC_InitStructure.ADC_Mode = ADC_Mode_RegInjecSimult; // 同时采样
    ...
    ADC_SoftwareStartInjectedConvCmd(ADC1,ENABLE); // 启动注入规则通道
}
